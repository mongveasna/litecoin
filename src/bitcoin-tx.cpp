...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s teacoind-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  teacoind-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded teacoind transaction") + "\n" +
              "  teacoind-tx [options] -create [commands]   " + _("Create hex-encoded teacoind transaction") + "\n" +
              "\n";
