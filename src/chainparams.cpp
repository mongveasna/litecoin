...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.teacoind.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.teacoindtools.com", true);
        vSeeds.emplace_back("dnsseed.teacoindpool.org", true);
        ...
        chainTxData = ChainTxData{
            ...
            1516116135, //1502955334, // * UNIX timestamp of last known number of transactions
            40253, //11428845,  // * total number of transactions between genesis and that timestamp
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.teacoindtools.com", true);
        vSeeds.emplace_back("seed-b.teacoind.loshan.co.uk", true);
