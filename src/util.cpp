...
const char * const BITCOIN_CONF_FILENAME = "teacoind.conf";
const char * const BITCOIN_PID_FILENAME = "teacoind.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/TeaCoin";
#else
    // Unix
    return pathRet / ".teacoind";
#endif
#endif
}
